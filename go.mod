...
require (
	...
	github.com/walterjwhite/go-application/libraries/after v0.0.0-20191016024017-f66dc0dce0ba
	...
	github.com/walterjwhite/go-application/libraries/logging v0.0.0-20191016031907-4c3bc5ee3d43

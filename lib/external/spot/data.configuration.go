...
import (
	...
	"github.com/walterjwhite/go/lib/external/spot/writer"
	"github.com/walterjwhite/go/lib/external/spot/writer/jsonfile"
...
func New(feedId string) *Configuration {
	...
	// TODO: generalize this so support other backends

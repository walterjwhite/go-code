...
require (
	...
	github.com/walterjwhite/go-application/libraries/io/writermatcher v0.0.0-20191016231652-295166390adb
	github.com/walterjwhite/go-application/libraries/logging v0.0.0-20191016231652-295166390adb
	github.com/walterjwhite/go-application/libraries/notification v0.0.0-20191016231652-295166390adb
